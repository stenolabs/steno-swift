...
- [ ] Native Gemma inference on macOS remains unavailable.
      ...
      A reviewed production checkpoint and matching resource limits in all three catalogs, user-facing import and provider-selection UI, explicit orphan and corrupt-install recovery, a real model run, and negative signed abuse or multiprocess XPC coverage remain open.
