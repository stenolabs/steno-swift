...
- [ ] Native Gemma inference on macOS remains unavailable.
      ...
      Consent-based model import and store, production Hardened Runtime validation, a buildable matched MLX dependency snapshot, provider activation, a real model run, and negative signed abuse or multiprocess XPC coverage remain open.
